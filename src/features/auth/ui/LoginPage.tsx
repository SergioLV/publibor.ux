...
import { apiLogin, setAuthToken } from '../api/auth-api';
import './Login.css';
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <div className="login-field">
            ...
            <div className="login-input-wrap">
              ...
              <input id="login-user" type="text" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="Ingrese su usuario" autoComplete="username" autoFocus />
            </div>
          </div>
          ...
          <div className="login-field">
            ...
            <div className="login-input-wrap">
              ...
              <input id="login-pass" type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Ingrese su contraseña" autoComplete="current-password" />
              <button type="button" className="login-eye" onClick={() => setShowPassword(!showPassword)} tabIndex={-1} aria-label={showPassword ? 'Ocultar contraseña' : 'Mostrar contraseña'}>
                {showPassword ? (
          ...
          <motion.button className="login-submit" type="submit" disabled={loading} whileTap={{ scale: 0.98 }}>
